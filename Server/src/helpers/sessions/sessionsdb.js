...
function joinSession(sessionId, user, callback) {
    ...
    isUserInAnySession(user.userId, function(err, inAnySession) {
        if (err) {
            ...
            callback(`User ${userId} is already in another session`);
        } else {
        ...
        if (err) {
            ...
            models.Books.findOne({
                ...
                if (err) {
                    ...
                    callback(`Book ${bookId} does not exist`);
                } else {
                    ...
                    newSession.save(function(err, result) {
                        if (err) {
                            ...
                            callback("An error has occured attempting to create a session");
                        } else {
                            ...
                            result.populate({
                                ...
                                if (err) {
                                    ...
                                    callback(`Book ${bookId} could not be populated after creating Session ${result._id}`);
                                } else {
                                    callback(err, result)
                ...
                if (err || !result) {
                    ...
                    result.populate({
                        ...
                        if (err) {
                            ...
                            callback(`Book ${bookId} could not be populated after finding the Session ${result._id}`);
                        } else {
                                    ...
                                    if (err || !result) {
                                        ...
                                        result.populate({
                                            ...
                                            if (err) {
                                                ...
                                                callback(`Book ${bookId} could not be populated after updating Session ${result._id}`);
                                            } else {
                                                callback(err, result);
                                                if (webSockets) {
