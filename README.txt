...
4). To start the server run the "npm run start-server" command.
...
npm run complete-test-reports       Runs both the Website and Server tests against the test database. Also produces test reports
